...
TRADUCTIONS = {
    "Español": {
        ...
        "chart_channel": "Canales", "chart_mp": "Marketplaces (Top 4 + Otros)", "chart_subcat": "Categoría", "chart_brand": "Top 5 Marcas", "chart_price": "Rango de Precios", "chart_country": "Países",
...
with st.sidebar:
    ...
    # LOGIQUE DATE MADRID
    now = datetime.now(MADRID_TZ) # Utilisation de l'heure locale Madrid
    today_dt = now.date()
...
def get_data_v100(start_date_limit):
    ...
    for o in orders:
        ...
        # CORRECTION : PARTIALLY REFUNDED = PAID
        ...
        clean_o.append({"date":created_at_dt, "total_ttc": total_eur, "raw_price_str": raw_price_str, "status": fin_status, "channel":c, "mp_name":mp, "order_name":o["name"], "parent_id": pid, "country": country, "sku": sku, "tags_list": t_tags})
